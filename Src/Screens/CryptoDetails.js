...
import {dummyData, COLORS, FONTS, Icons, SIZES, Images} from '../Constants';
...
const CryptoDetails = ({route, navigation}) => {
  ...
  const [chartOptions, setChatOptions] = React.useState(dummyData.chartOptions);
          ...
          {chartOptions.map(option => {
            return (
              <TextButton
                ...
                customLabelStyle={{
                  color:
                    selectedOption == option.id ? COLORS.white : COLORS.gray,
                  ...FONTS.body5,
                }}
